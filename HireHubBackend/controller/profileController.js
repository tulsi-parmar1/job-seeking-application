...
export const postInfo = async (req, res) => {
    const { degree, tenth, twelth, sdegree, stenth, stwelth, edegree, etenth, etwelth, skills, about } = req.body;
...
export const profileChange = async (req, res) => {
    try {
        ...
        const cloudinaryResponse = await cloudinary.uploader.upload(profile.tempFilePath, { folder: 'HireHub' });
