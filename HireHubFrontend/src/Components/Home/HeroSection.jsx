        ...
        <>
            <div className={style.hero}>
                ...
                <div className={style.content}>
                    <h1 ref={gsapRef}> Welcome,<span style={{ color: '#088395' }}>{users.name}</span>!</h1>
                    <h2 ref={textRef}>Unlock Your Professional Potential </h2>
                    <p ref={secondTextRef}>Connecting top talent with exceptional opportunities. <br />
                        Where your next great hire is just a  <span className={style.span}> click away. </span></p>
                    <button onClick={handleonclick} ref={btnRef}>Find Job</button>
                </div>
